...
//     }
 ...
 echo "Exit Cope car"
        ...
        //     deploy_result = bat (returnStdout: true, script: "cd ${ei_service_project_tem_path}/solar-system-api && mvn  deploy -Dmaven.deploy.skip=true -Dmaven.car.deploy.skip=false -Dmaven.test.skip=true -Dmaven.wagon.http.ssl.insecure=true || echo success")
        //      is_car_deploy_error = deploy_result.contains("[ERROR]")
